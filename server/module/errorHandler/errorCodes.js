const codes = [
  ...
  { code: 'E011004', http: 500, message: { zh: '系統錯誤 (E0011004)', en: 'System error (E0011004).' } }, // 內部API沒有回應
  { code: 'E011005', http: 500, message: { zh: '系統錯誤 (E0011005)', en: 'System error (E0011005). {{$msg}}' } }, // 外部API錯誤
];
...
// 用code字串來回傳error的物件
_public.get = (c) => {
  // const found = codes.find((f) => f.code === c);
